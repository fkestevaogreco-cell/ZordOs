...
description: >
  ...
  foco atual e identidade visual, e preenche `_memoria/perfil.md`, `_memoria/preferencias.md`,
  `_memoria/foco.md`, `identidade/design-guide.md` e adapta o `CLAUDE.md` conforme o perfil.
...
✓ Contexto do negócio: _memoria/perfil.md
✓ Tom de voz: _memoria/preferencias.md
✓ Foco atual: _memoria/foco.md
